...
void UMainMenuWidget::OnGameLoadedFixup(UWorld* World)
{
	...
	AMasteringCharacter* Char = nullptr; // if ever more than one, we'll need an array and a m,ap for their inventory
	...
	//Assuming we found our player character and saved out some inventory, this is where we do custom serialization and fix-up
...
{
	//Save timestamp, then spilt map name with _ character
	FGameSavedData SaveGameData;
